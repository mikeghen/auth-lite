...
var ses = new AWS.SES({ region: process.env.SERVERLESS_REGION });
...
function sendVerificationEmail(email, token, fn) {
  console.log('sendEmails');
	var subject = 'Verification Email for ' + process.env.EXTERNAL_NAME;
	var verificationLink = process.env.VERIFICATION_PAGE + '?email=' + encodeURIComponent(email) + '&verify=' + token;
	ses.sendEmail({
